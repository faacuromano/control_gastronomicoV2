  ...
  sections: [
    ...
    // ========== CONTENIDO PRINCIPAL ==========
    {
      ...
      children: [
        ...
        new Paragraph({ heading: HeadingLevel.HEADING_2, children: [new TextRun("Progreso de Remediaci\u00f3n")] }),
        new Paragraph({ spacing: { after: 100 }, children: [new TextRun({ text: `Al 1 de febrero de 2026, ${fixedCount} de ${severityCounts.Total} hallazgos (${Math.round(fixedCount/severityCounts.Total*100)}%) han sido remediados en 5 rondas de correcciones. Los 30 items de la hoja de ruta (Tier 1 + 2 + 3) est\u00e1n completos.`, size: 22 })] }),
        new Table({
          columnWidths: [3120, 3120, 3120],
          rows: [new TableRow({ children: [
            new TableCell({ borders: cellBorders, width: { size: 3120, type: WidthType.DXA }, shading: fixedShading, children: [
              new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 200, after: 40 }, children: [new TextRun({ text: "Hallazgos Corregidos", size: 20, color: "2E7D32", bold: true })] }),
            ...
            new TableCell({ borders: cellBorders, width: { size: 3120, type: WidthType.DXA }, shading: fixedShading, children: [
              new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 200, after: 40 }, children: [new TextRun({ text: "Items de Hoja de Ruta", size: 20, color: "2E7D32", bold: true })] }),
            ...
            new TableCell({ borders: cellBorders, width: { size: 3120, type: WidthType.DXA }, shading: { fill: "FFF3E0", type: ShadingType.CLEAR }, children: [
              new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 200, after: 40 }, children: [new TextRun({ text: "Restantes", size: 20, color: "E65100", bold: true })] }),
        ...
        new Paragraph({ spacing: { before: 100, after: 200 }, children: [
          new TextRun({ text: "Los items restantes son principalmente de severidad Baja/Info: documentaci\u00f3n de versionado API, anotaciones OpenAPI, estrictez de tipos, logging de infraestructura y mejoras cosm\u00e9ticas.", size: 20, color: "546E7A", italics: true }),
        ]}),
        ...
        ...Object.entries(findings).flatMap(([category, items]) => [
          ...
          new Table({
            ...
            rows: [
              new TableRow({ children: [hdrCell("ID", 800), hdrCell("Sev", 700), hdrCell("Problema", 1900), hdrCell("Archivo", 1500), hdrCell("Impacto", 1500), hdrCell("Correcci\u00f3n", 1660), hdrCell("Estado", 1300)] }),
              ...items.map((f, i) => {
                ...
                return new TableRow({ children: [
                  ...
                  cell(isFixed ? "CORREGIDO" : "PENDIENTE", 1300, { bold: true, color: isFixed ? "2E7D32" : "CC0000", shading: rowShading }),
                ]});
              }),
            ],
          }),
        ...
        ...roadmap.flatMap(tier => {
          ...
          new Paragraph({ spacing: { after: 100 }, children: [
            ...
            new TextRun({ text: `  [${tierFixed}/${tierTotal} completados]`, size: 22, bold: true, color: tierFixed === tierTotal ? "2E7D32" : "E65100" }),
          ]}),
          new Table({
            columnWidths: [1000, 3560, 1000, 2500, 1300],
            rows: [
              new TableRow({ children: [hdrCell("Fix #", 1000), hdrCell("Descripci\u00f3n", 3560), hdrCell("Esfuerzo", 1000), hdrCell("Dependencia", 2500), hdrCell("Estado", 1300)] }),
        ...
        new Table({
          ...
          rows: [
            new TableRow({ children: [hdrCell("ID", 1000), hdrCell("Severidad", 900), hdrCell("T\u00edtulo", 2500), hdrCell("Archivo", 3660), hdrCell("Estado", 1300)] }),
