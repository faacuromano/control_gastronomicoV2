...
class OrderNumberService {
    /**
     * Generate the next order number using date-based sharding with explicit row locking.
     *
    ...
    async getNextOrderNumber(tx) {
        try {
            // Calculate business date using centralized utility (6 AM cutoff)
    ...
    async initializeFromExistingOrders() {
        logger_1.logger.warn('initializeFromExistingOrders is deprecated with date-based sharding');
        return 0;
    }
}
exports.OrderNumberService = OrderNumberService;
exports.orderNumberService = new OrderNumberService();
//# sourceMappingURL=orderNumber.service_OLD.js.map