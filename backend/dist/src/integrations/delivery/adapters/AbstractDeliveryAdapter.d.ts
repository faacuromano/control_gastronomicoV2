...
import type { DeliveryPlatformCode, NormalizedOrderStatus, MenuSyncResult, AvailabilityUpdate, StatusUpdateResult, ProcessedWebhook } from '../types/normalized.types';
/**
 ...
 * ```
 */
export declare abstract class AbstractDeliveryAdapter {
     ...
     */
    abstract updateOrderStatus(externalOrderId: string, status: NormalizedOrderStatus): Promise<StatusUpdateResult>;
    /**
     ...
     */
    protected computeHmac(body: Buffer, secret: string, algorithm?: 'sha256' | 'sha512'): string;
    /**
...
//# sourceMappingURL=AbstractDeliveryAdapter.d.ts.map