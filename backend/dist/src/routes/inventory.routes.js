...
const IngredientController = __importStar(require("../controllers/ingredient.controller"));
const StockController = __importStar(require("../controllers/stockMovement.controller"));
