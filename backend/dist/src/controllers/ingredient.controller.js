...
exports.getIngredients = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const ingredients = await ingredientService.getAll();
    res.json({ success: true, data: ingredients });
});
exports.getIngredientById = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.createIngredient = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.updateIngredient = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const id = parseInt(req.params.id || '0');
    if (isNaN(id)) {
        return res.status(400).json({ success: false, error: 'Invalid ID' });
    }
...
exports.deleteIngredient = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const id = parseInt(req.params.id || '0');
    if (isNaN(id)) {
        return res.status(400).json({ success: false, error: 'Invalid ID' });
    }
