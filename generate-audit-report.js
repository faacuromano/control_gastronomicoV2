...
const categoryScores = [
  { category: "Security",       weight: "20%", score: 75, rationale: "25/43 findings fixed. XSS sanitization, CORS hardening, webhook rate limiting, cross-tenant validation, max length validation added. Remaining: CSP tuning, signature rotation, Docker secrets." },
  { category: "Error Handling",  weight: "15%", score: 72, rationale: "7/16 fixed. QR collision retry added, error differentiation improved. Remaining: KDS broadcast recovery, feature flag error alerting." },
  ...
  { category: "Database",        weight: "12%", score: 78, rationale: "8/18 fixed. TOCTOU races in supplier/category wrapped in transactions. Remaining: connection pooling, payment sync rollback." },
  ...
  { category: "Performance",     weight: "8%",  score: 72, rationale: "7/21 fixed. Stock alert throttling, reduced default limits, pagination. Remaining: batch stock, printer routing optimization." },
